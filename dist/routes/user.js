...
router.post("/add", multerConfig_1.default.fields([{ name: "photo", maxCount: 1 }]), validation_1.validateCreate, validation_1.handleValidationErrors, user_1.CreateUserControllers);
