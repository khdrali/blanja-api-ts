...
const CreateUserController = (params) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    return yield (0, db_1.default) `INSERT INTO public.user(username,email,password,phone,photo) VALUES (${params === null || params === void 0 ? void 0 : params.username},${params === null || params === void 0 ? void 0 : params.email},${params === null || params === void 0 ? void 0 : params.password},${params === null || params === void 0 ? void 0 : params.phone},${(_a = params === null || params === void 0 ? void 0 : params.photo) !== null && _a !== void 0 ? _a : null}) RETURNING *`;
});
